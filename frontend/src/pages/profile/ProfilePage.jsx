...
import { ProfileHeaderSkeleton } from "../../components/components";
import { EditProfileModal } from "../pages";
...
export const ProfilePage = () => {
  ...
  const handleFeedTypeChange = (type) => setFeedType(type);
            ...
            <>
              ...
              <div className="flex w-full border-b border-gray-700 mt-4">
                ...
                <div
                  ...
                  onClick={() => handleFeedTypeChange("likes")}
                >
                  Likes
                  {feedType === "likes" && (
                    <div className="absolute bottom-0 w-10  h-1 rounded-full bg-primary" />
